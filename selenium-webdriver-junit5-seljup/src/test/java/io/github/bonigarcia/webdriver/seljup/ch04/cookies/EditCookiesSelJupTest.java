 ...
 *
 */
package io.github.bonigarcia.webdriver.seljup.ch04.cookies;
...
class EditCookiesSelJupTest {
    ...
    @Test
    void testEditCookie(ChromeDriver driver) {
        driver.get(
        ...
        Cookie readCookie = driver.manage().getCookieNamed(username.getName());
