 ...
 *
 */
package io.github.bonigarcia.webdriver.seljup.ch5.bidi;
...
class ConsoleEventsChromeSelJupTest {

    static final Logger log = getLogger(lookup().lookupClass());

    @Test
    void testConsoleEvents(ChromeDriver driver) throws InterruptedException {
