 ...
 *
 */
package io.github.bonigarcia.webdriver.seljup.ch05.cdp.network_interceptor;
...
class NetworkInterceptorEdgeSelJupTest {

    static final Logger log = getLogger(lookup().lookupClass());

    @Test
    void testNetworkInterceptor(EdgeDriver driver) throws Exception {
        Path img = Paths
