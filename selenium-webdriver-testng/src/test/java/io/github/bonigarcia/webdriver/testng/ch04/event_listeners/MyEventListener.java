...
public class MyEventListener implements WebDriverListener {
    ...
    private void takeScreenshot(WebDriver driver) {
        ...
        String screenshotFileName = generateScreenshotFileName(sessionIdStr);
    ...
    private String generateScreenshotFileName(String sessionId) {
        Date today = new Date();
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy.MM.dd_HH.mm.ss.SSS");
        return String.format("%s-%s.png", dateFormat.format(today), sessionId);
    }
